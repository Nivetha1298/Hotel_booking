        ...
        <FontAwesomeIcon icon={ faCircleArrowRight}   className="arrow"
          ...
          <button className="bookNow">Reserve or Book Now!</button>
            ...
            <div className="hotelAddress">
              ...
              <span>110 Rajiv Gandhi Salai, Old, Mahabalipuram Rd, Chennai, Tamil Nadu 600041</span>
            </div>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              <p className="hotelDesc">
                Located a 5-minute walk from Old Mahapallipuram, Tower
                ...
                airport is Meenambakkam Airport, 16.1 km
